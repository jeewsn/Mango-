 ...
 * @author Tuk
 */
public class VDeposit extends javax.swing.JFrame {

    /**
     * Creates new form JDeposit
     */
    public VDeposit() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VDeposit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
