 ...
 * @author halo
 */
public class TransferGetIDController 
{
    inrFrame theView ;
    MtrangetID theModel;
    public TransferGetIDController(SuperPanels theView , MtrangetID theModel)
    {
        this.theModel=theModel;
        this.theView =new inrFrame(theView);
        this.theView.addListener(new TransferGetIDController.listenerGetID());
    }
    class listenerGetID implements ActionListener
        {
            @Override
