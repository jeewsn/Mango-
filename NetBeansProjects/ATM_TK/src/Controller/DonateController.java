...
import ModelV2.MDonate;
import View.Panel.DonatePanel;
 ...
 */
    ...
    inrFrame theView;
    ModelV2.MDonate theModel;
    String accNo,name,balance;
    public DonateController( String name ,String accNo,String balance )
    {
        this.theView = new inrFrame(new DonatePanel());
        this.theModel= new MDonate();
        this.theView.addListener(new listenerDonate());
        this.balance = balance;
        this.accNo = accNo;
        this.name = name;
        
    }
    class listenerDonate
            implements ActionListener
    {
		...
		else if(command.equals("Login")||command.equals("Enter"))
		{
                        ...
                        if(!theModel.checkTranID(theView.getUserPanel()))
                        {
                            theView.showMessage("Please Check Foundation");
